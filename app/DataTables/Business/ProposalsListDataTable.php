        ...
        return datatables()
            ...
            ->addColumn('action', function ($query){
                $output = '<div class="btn" style="display: inline-flex;">
                        <a href="'.route('business.dashboard.proposal.show', $query->id).'" title="Proposal Details" class="btn table-btn btn-icon btn-primary btn-sm shadow-primary p-0 mr-2"><i class="fa mt-2 fa-eye"></i></a>
                        ';
